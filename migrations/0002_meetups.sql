...
Dave Rupert is co-founder of Luro, a tool for tracking component usage and insights. He also co-hosts Shoptalk, a web design and development podcast with Chris Coyier from CSS-Tricks.', '2023-07-18', 'Cloudflare Austin', 1),
(3, '4 or more package managers, what''s the worst that could happen?', 'JavaScript has a horribly rich history of writing package managers with none fully reigning as the final winner in a perpetual war for popularity and utility. Let''s cover some of their differences, that actually end up with some fun surprises about nuances in how they work along the way!', '2023-08-15', 'Cloudflare Austin', 1),
...
This can be a great solution if you’re a web developer and JavaScript is your bread and butter. Apps built this way work fast, are quick to deploy, and don’t have to pass App Store reviews every time! So come and learn about the pros and cons of this approach, and what it takes to build a JS native mobile app.', '2023-10-17', 'Cloudflare Austin', 1),
(6, 'Remix: Teaching Young Dogs new Tricks', 'Remix is a full stack web framework that lets you focus on the user interface and work back through web standards to deliver a fast, slick, and resilient user experience. In this talk Brooks will show you how Remix makes it easy to iteratively build solid, engaging, and user-centric experiences using the basic building blocks of the web.', '2024-01-16', 'Cloudflare Austin', 1);

INSERT INTO speakers (id, name, bio, profile_src, event_id) VALUES
(1, 'Jeff Lindsay', 'Webhooks, TIGSource, SHDH, NASA, Twilio, Docker, plenty more. Optimism of the will. Follow your curiosity.', 'https://austinjavascript.com/assets/avatar/p5r76YVWyR-96.jpeg', 1),
(2, 'Dave Rupert', 'Dave Rupert is lead developer and 1/3rd of Paravel. He is also the host of the ATX Web Show, a not-so-weekly podcast all about the local web design and development scene here in Austin, TX.', 'https://austinjavascript.com/assets/avatar/eBfu-6JNRD-96.jpeg', 2),
(3, 'Bradley Farias', 'Head of Open Source Security at @SocketSecurity. Thoughts are my own. He/him.', 'https://austinjavascript.com/assets/avatar/I7ujQtgPaC-96.jpeg', 3),
(4, 'Charles Lowell', 'Charles has been delivering bullet-proof software for over 18 years. An avid contributor to open source, he founded the Frontside in 2005 to help businesses deliver game-changing user interfaces to their customers. Also, he really, really, really, really likes to code. Really.', 'https://austinjavascript.com/assets/avatar/5hczD9uc8g-96.jpeg', 4),
(5, 'Anton Astashov', 'Anton is a real-deal code slinger based in Austin and currently working at Mixbook.com.', 'https://austinjavascript.com/assets/avatar/Mb8LHQi_iN-96.jpeg', 5),
(6, 'Brooks Lybrand', 'Remix Developer Relations Manager at Shopify', 'https://austinjavascript.com/assets/avatar/148u8dxev7-96.jpeg', 6);
